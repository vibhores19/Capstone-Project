...
using DataFrames, CSV, GLM,Plots,StatsPlots, LinearAlgebra, Distributions,  HypothesisTests, Statistics, PrettyTables

# ╔═╡ 9116ea87-ff8d-4cf0-b603-6105a55178e1
using CategoricalArrays

# ╔═╡ b54c0f0e-6523-4994-ac0d-8fc2791bacf6


# ╔═╡ fa9cc654-7149-4169-b3ce-ef9098f2aa1e


# ╔═╡ 53386023-10fd-4419-9733-beeb14bbc57e


# ╔═╡ e9b2f51f-fb27-4054-916c-e789a25b340f
...
# ╔═╡ 544d9484-3af5-4fb6-9379-bef758493d32
...
# ╔═╡ 389e44f2-035e-4ff6-97d0-5c2b2f4b9c08


# ╔═╡ fd5e03ea-bbc5-42d4-81b5-752e7aefe99c


# ╔═╡ 800803b6-fb97-40e5-81ce-3f74a37bdcca


# ╔═╡ f4a06e68-141b-4b9b-a9af-d180d49ed52d


# ╔═╡ f02f76ab-e0b6-4eed-9b3b-42c13e3f3a90


# ╔═╡ 7a1d7635-e69c-4081-8fe2-3e96a0faf17a


# ╔═╡ 96def9ed-66b6-4a26-b696-6bea789887dc


# ╔═╡ ebb1fd7e-5098-4589-985b-adf2e894d210


# ╔═╡ 01e9db3c-d2a8-4242-915c-a4abf7788496
...
# ╔═╡ 3561e7e3-a555-421f-9d74-dd09d2282439
describe(roomwidth.converted_width)

# ╔═╡ 3294ec12-5373-4a21-b444-89dd80c24e6b
begin
	# Summary statistics for both feet and metre estimates (converted)
	summary_stats = combine(groupby(roomwidth, :unit), :converted_width => describe)
...
# ╔═╡ 2c0b4fac-83d2-47ce-a453-252d889b5aba
...
# ╔═╡ 753b5c40-4a78-452e-b28b-4a830b1adeb4
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ 96c76c76-be8e-480d-b159-0993e758e501
# ╠═╡ disabled = true
#=╠═╡
p_value_wilcox = pvalue(wilcox_test)
...
# ╔═╡ 993238f1-762d-4260-8525-a4f83548897a
# ╠═╡ disabled = true
#=╠═╡
u_statistic = wilcox_test.U
...
# ╔═╡ 1d7e7154-b712-459a-a76a-5c7fdde68d92
begin
	pairwise_diffs = [x - y for x in feet_data for y in metres_data]	
end

# ╔═╡ 26281d1d-51e2-4d54-844d-92bf75d5380a
begin
	# Display the results
	println("Wilcoxon Rank-Sum (Mann-Whitney U) Test Result:")
	println(wilcox_test)
...
# ╔═╡ d744ddaa-6d83-48e6-bc8c-8102507c6e3d
begin
	println("\nW (U statistic): ", u_statistic)
	println("P-Value: ", p_value_wilcox)
	println("Sample Estimate (Difference in Location): ", location_diff)
...
# ╔═╡ 903eaa7e-71ea-48b0-a7de-947832aa8783
begin
...
# ╔═╡ c3d47e32-d0cd-44d9-a6a7-d8dbb2cfc304
row_totals = sum(pistonrings, dims=2)


# ╔═╡ 7515d9f3-992c-40d2-a7b5-e33824452bb6
col_totals = sum(pistonrings, dims=1)


# ╔═╡ 3974e75e-7e8d-497e-9d96-40436c363937
total = sum(pistonrings)


# ╔═╡ d04999d2-5ac5-4196-b981-b30f6ffd7df5
expected_frequencies = row_totals * col_totals / total


# ╔═╡ b06bc8ae-ca56-4966-92e3-d054ed191578
residuals = (pistonrings .- expected_frequencies) ./ sqrt.(expected_frequencies)


# ╔═╡ 1ff2f0ab-9e43-4f64-980e-bb35808ed7fe
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ db89973c-3f9c-406f-87a5-41312bca0a29
begin
...
# ╔═╡ c19ff3d0-fdd2-476f-8f72-8f0f7ca56ab4
...
# ╔═╡ a2b059d1-0e29-47ed-839e-038cc24ad06c
# ╠═╡ disabled = true
#=╠═╡
...
# ╔═╡ 6ea4740e-fede-4068-8f90-42d023051657


# ╔═╡ 4ff37d6c-f898-4527-8dbb-f5c61efa2b78
...
# ╔═╡ 6955c0ea-341e-4744-87b2-03d4c30895b6
...
# ╔═╡ 3c225e1a-704d-47a3-b15c-33a62837405c
...
manifest_format = "2.0"
project_hash = "3f6533dc8558e4f87c90fe2c015ac8633b57132e"
